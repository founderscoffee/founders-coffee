...
5. **CO-02 / P0-018 / P1-009:** replace one-minute polling with per-event Durable Object alarms
   feeding the environment-specific Notifications Queue. Consumers and DLQs are declared and have
   dated deployment evidence; the missing part is the producer/alarm path, not consumer reachability.
