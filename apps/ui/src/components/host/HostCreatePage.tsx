...
export const HostCreatePage = ({
  ...
  const stepperSegments = [
    venue ? (
      <span
        key="loc"
        className="flex min-w-0 max-w-full items-center gap-1.5 rounded-full border border-base-300/70 bg-base-100 px-2.5 py-1 shadow-sm"
      >
                  ...
                  <div className="mt-6 flex min-h-0 flex-1 flex-col">
                    {step === 1 && (
                      <div className="mt-auto flex flex-col gap-3">
                        ...
                        <ClientOnly
                          fallback={
                            <div className="h-14 rounded-xl bg-base-200" />
                          }
                        >
                          <Suspense
                            fallback={
