...
export const EG_STATES: readonly GeoState[] = [
  { code: '1', name: 'Cairo', nameAr: 'القاهرة', nameFr: 'Le Caire' },
  { code: '2', name: 'Giza', nameAr: 'الجيزة', nameFr: 'Gizeh' },
  { code: '3', name: 'Alexandria', nameAr: 'الأسكندرية', nameFr: 'Alexandrie' },
  { code: '4', name: 'Dakahlia', nameAr: 'الدقهلية' },
  { code: '5', name: 'Red Sea', nameAr: 'البحر الأحمر', nameFr: 'Mer Rouge' },
  { code: '6', name: 'Beheira', nameAr: 'البحيرة' },
  { code: '7', name: 'Fayoum', nameAr: 'الفيوم' },
  { code: '8', name: 'Gharbiya', nameAr: 'الغربية' },
  { code: '9', name: 'Ismailia', nameAr: 'الإسماعلية', nameFr: 'Ismaïlia' },
  ...
  { code: '15', name: 'Aswan', nameAr: 'اسوان', nameFr: 'Assouan' },
  { code: '16', name: 'Assiut', nameAr: 'اسيوط', nameFr: 'Assiout' },
  { code: '17', name: 'Beni Suef', nameAr: 'بني سويف', nameFr: 'Beni Souef' },
  { code: '18', name: 'Port Said', nameAr: 'بورسعيد', nameFr: 'Port-Saïd' },
  { code: '19', name: 'Damietta', nameAr: 'دمياط', nameFr: 'Damiette' },
  ...
  { code: '24', name: 'Luxor', nameAr: 'الأقصر', nameFr: 'Louxor' },
