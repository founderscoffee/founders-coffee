...
export const CLOSEOUT_PROMPT_DELAY_MS = 30 * 60 * 1000;

export const CLOSEOUT_PROMPT_BACKFILL_WINDOW_MS = 14 * DAY_MS;
export const DID_NOT_HAPPEN_BACKFILL_WINDOW_MS = 3 * DAY_MS;
