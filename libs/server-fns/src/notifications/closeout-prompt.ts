 ...
 * event ends, and an event with no recorded end is a first-class case rather than bad data
 ...
 *
 * The market flag is deliberately **not** checked here. Delivery is gated at send time in
 * `resolveDestination`, which is the one place every channel already passes through and
